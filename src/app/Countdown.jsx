...
const COUNTDOWN_FROM = '2024-05-25';
...
const StickyCountdown = () => {
  ...
  return (
    <div className="sticky left-0 right-0 top-0 z-50 w-full bg-yellow-500 px-2 py-0.5 text-white shadow-md">
      <div className="mx-auto flex w-fit max-w-5xl flex-wrap items-center justify-center gap-x-4 text-xs md:text-sm">
        <CountdownItem text="Presale:" />
